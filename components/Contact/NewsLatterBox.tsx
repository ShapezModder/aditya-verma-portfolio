...
const NewsLatterBox = () => {
  ...
  return (
    <div
      className="wow fadeInUp shadow-three relative z-10 rounded-sm bg-black border border-gray-800 p-8 sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-white">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b border-gray-700 border-opacity-25 pb-11 text-base leading-relaxed text-gray-300">
