...
const SingleBlog = ({ blog }: { blog: Blog }) => {
  ...
  return (
    <motion.div
      className="group relative overflow-hidden rounded-sm bg-white shadow-one transition-all duration-300 hover:shadow-two dark:bg-dark dark:hover:shadow-gray-dark"
    ...
    >
        ...
        <div className="p-6 sm:p-8 md:px-6 md:py-8 lg:p-8 xl:px-5 xl:py-8 2xl:p-8">
          <h3>
            <Link
              href="/blog-details"
              className="mb-4 block text-xl font-bold text-black transition-colors duration-300 hover:text-primary dark:text-white dark:hover:text-primary sm:text-2xl"
            >
              {title}
            </Link>
          </h3>
