            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <motion.nav
                  ...
                  transition={{ duration: 0.3 }}
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-white px-6 py-4 dark:border-body-color/20 dark:bg-dark lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${
