      ...
      <section className="relative py-20 overflow-hidden" style={{ zIndex: 10 }}>
        <div className="container relative z-10 mx-auto px-4">
          ...
          >
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 sm:p-12 shadow-2xl">
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:adityaverma9777@gmail.com"
